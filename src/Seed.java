    ...
    public static void seed() {
        try {
            ...
            try {
                ...
                stmt.executeUpdate("CREATE TABLE Service_Record (service_request_id integer NOT NULL PRIMARY KEY auto_increment, checkin_id integer NOT NULL, room_id integer NOT NULL, submitter_id integer NOT NULL, customer_id integer NOT NULL, type varchar(10) NOT NULL, complete boolean NOT NULL, date varchar(40) NOT NULL, cost float NOT NULL)");
